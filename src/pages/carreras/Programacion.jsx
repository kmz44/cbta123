      ...
      <div style={{
        ...
        <section style={{
          ...
          <h2 style={{
            ...
            textAlign: 'center',
            marginBottom: '20px',
            borderBottom: isDark ? '2px solid #4a5568' : '2px solid #e2e8f0',
            paddingBottom: '10px'
          }}>📚 Plan de Estudios Oficial</h2>
          ...
          <p style={{
            ...
            Consulta el programa de estudios completo y oficial de la carrera Técnico en Programación.
          </p>
          
          <div style={{
            background: isDark ? '#0f1720' : '#f8f9fa',
            borderRadius: '15px',
            padding: '20px',
            boxShadow: isDark ? '0 8px 25px rgba(0,0,0,0.6)' : '0 8px 25px rgba(0,0,0,0.1)'
          }}>
            <iframe
              src="/programa de estudios/PROGRAMA DE ESTUDIOS PROGRAMACION.pdf"
              style={{
                width: '100%',
                height: '600px',
                border: 'none',
              ...
              title="Plan de Estudios - Técnico en Programación"
            />
            
            <div style={{textAlign: 'center', marginTop: '15px'}}>
              <a 
                href="/programa de estudios/PROGRAMA DE ESTUDIOS PROGRAMACION.pdf"
                download="Plan_Estudios_Programacion.pdf"
                style={{
                  display: 'inline-block',
